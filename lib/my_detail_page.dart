            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Container(
                    margin: const EdgeInsets.only(left: 10, top: 20, bottom: 20, right: 10),
                    child: Column(
                      children: [
                        Container(
                          child: Row(
                        ...
                        SizedBox(height: 20),
                        Expanded( // Wrap the Text with Expanded to take available vertical space
                          child: Container(
                            width: width,
                            child: Text(
                              Get.arguments['text'],
                        ...
                        Row(
                          ...
                          children: [
                            Expanded( // Wrap each section in Row with Expanded to take available horizontal space
                              child: Row(
                  ...
                  child: Row(
                    children: [
                      Container(
                          ...
                          child: IconButton(
                              color:Colors.white, onPressed: () =>fav.favCounter(), icon: Icon(Icons.favorite_border),
                          )
                      ),
                      SizedBox(width: 10,),
                      Text(
